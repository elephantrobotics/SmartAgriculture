...
class VideoCaptureThread(threading.Thread):
    ...
    def get_depth_frame(self, frame):
        ...
        if color_frame != None and depth_frame != None:
            ...
            self.color_width = color_frame.width()    # 彩色帧宽度
            self.color_height = color_frame.height()  # 彩色帧高度

            self.depth_width = depth_frame.width()    # 深度帧宽度
            self.depth_height = depth_frame.height()  # 深度帧高度
